...
scanning in the text of old novels to your database. At first it seems to capture words okay, but you quickly 
...
function stringClean(s){
  //use replace method with regex looking for any numbers and replace with nothing
